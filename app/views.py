...
def post_add():
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            post = models.Post(title=request.form.get('title'), is_boom_news=request.form.get('is_boom_news'), content=request.form.get('content'),
...
def post_delete(post_id):
    post = models.Post.query.filter_by(id=post_id).first()
    if post:
        if request.method ==current_user.id:
            if request.method =='POST':
